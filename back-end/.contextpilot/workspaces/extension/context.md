...
## 💡 Decisão chave
- O extension será usado para armazenar o próprio contexto do desenvolvimento dele mesmo.
- Caso o SaaS não finalize a tempo, o extension será pivotado para submission no World Hackathon.
...
- Integrar snapshot ao fluxo principal do extension.
