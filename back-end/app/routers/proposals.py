...
async def create_proposal(
    ...
    """
    logger.info(
        f"Creating proposal: {proposal.proposal_id} by {proposal.agent}"
    )
...
async def approve_proposal(
    proposal_id: str,
    request: ProposalApprovalRequest = Body(...)
):
    """
    Approve a proposal.
    ...
    try:
        ...
        event_bus.publish(
            ...
            data={
                ...
                "changes": [c.model_dump() for c in (request.edited_changes or proposal.changes)],
...
async def reject_proposal(
    proposal_id: str,
    request: ProposalRejectionRequest = Body(...)
):
    """
