...
gcloud run deploy $SERVICE_NAME \
    ...
    --min-instances 0 \
    --timeout 900 \
    --set-env-vars "ENVIRONMENT=development,STORAGE_MODE=cloud,REWARDS_MODE=firestore,EVENT_BUS_MODE=pubsub,USE_PUBSUB=true,GCP_PROJECT_ID=$PROJECT_ID,SANDBOX_ENABLED=true,CODESPACES_ENABLED=true,BRANCH_NAME=$BRANCH_NAME" \
